public class COIntervalObject implements Interval {  //closed-open interval [1.2, 4.5)
    private double left;    
    private double right;
		
    public COIntervalObject(double left, double right) {
    ...
    public double getRight() {
 	...
 	public String toString() {
 		return "COInterval: " + "[" + this.left + this.right + ")"; 
 	}
