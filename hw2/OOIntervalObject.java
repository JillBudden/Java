public class OOIntervalObject implements Interval {  //open-open interval (1.2, 4.5)
    private double left;    
    private double right;
		
    public OOIntervalObject(double left, double right) {
    ...
    public double getRight() {
 	...
 	public String toString() {
 		return "OOInterval: " + "(" + this.left + this.right + ")"; 
 	}
