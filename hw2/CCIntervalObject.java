public class CCIntervalObject implements Interval {  //closed-closed interval [1.2, 4.5]
    private double left;    
    private double right;
		
    public CCIntervalObject(double left, double right) {
	...
	public boolean overlaps(Interval i) {
 	...
 	public String toString() {
 		return "CCInterval: " + "[" + this.left + this.right + "]"; 
 	}
